...
public final class PrefUtils {
    ...
    //存对象
    public static void putBean(Context context, String key, Object value) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        try {
            ...
            String base64Student = Base64.encodeToString(byteArrayOutputStream.toByteArray(), Base64.DEFAULT);
            prefs.edit().putString(key, base64Student).apply();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static Object getBean(Context context, String key) {
        ...
        byte[] base64Student = Base64.decode(valueString, Base64.DEFAULT);
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(base64Student);
        try {
