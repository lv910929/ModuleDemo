...
public class MyWebChromeClient extends WebChromeClient {
    ...
    public MyWebChromeClient(OpenFileChooserCallBack mOpenFileChooserCallBack, LollipopFileCallBack lollipopFileCallBack, ProgressChangeCallBack progressChangeCallBack) {
    ...
    public void onProgressChanged(WebView view, int newProgress) {
        ...
        progressChangeCallBack.onProgressChange(view, newProgress);
